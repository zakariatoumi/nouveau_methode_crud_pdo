...
<div class="container">
  ...
  <form class="form-horizontal" action="c.php?t=produit&a=create" method="post">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="prix" name="prix" placeholder="0" class="form-control input-md" required="" type="text">
